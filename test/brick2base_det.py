...
C_PARAM = [31950/(0.5*49.13434*1.777778), 23950/(0.5*49.13434), 319.5, 239.5]  # 相机4个内参

class brick_detection:
    def __init__(self):
        self.image_pub = rospy.Publisher("brick_position", Floats,queue_size=4)
    ...
    def callback(self, data):
        ...
        if img_position[1] == 0 :
            ...
            #cv2.circle(cv_image, tuple([340,240]), 5, (0, 255, 0))  # 画圆
    ...
    def brick2base(self, brick2camera):
        #define a tf::PointStamped of the position that brick in camera
        ...
        try:
            ...
            #transform the position from camera to base_link of ur5
